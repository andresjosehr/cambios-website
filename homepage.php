...
<!-- ##### Hero Area Start agg by esthefa ##### -->
    ...
    <div class="testimonials-area section-padding-100 bg-img bg-overlay" style="background-image: url(<?= get_template_directory_uri() ?>/template/img/bg-img/bg-2.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="400ms">
                        <div class="testimonial-thumb">
                            <img src="<?= get_template_directory_uri() ?>/template/img/bg-img/t1.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="500ms">
                        <div class="testimonial-thumb">
                            <img src="<?= get_template_directory_uri() ?>/template/img/bg-img/t2.jpg" alt="">
                        </div>
                        <div class="testimonial-content">
                ...
                <div class="col-12 col-md-6">
                    <div class="single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="600ms">
                        <div class="testimonial-thumb">
                            <img src="<?= get_template_directory_uri() ?>/template/img/bg-img/t3.jpg" alt="">
                        </div>
                        <div class="testimonial-content">
                ...
                <div class="col-12 col-md-6">
                    <div class="single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="700ms">
                        <div class="testimonial-thumb">
                            <img src="<?= get_template_directory_uri() ?>/template/img/bg-img/t4.jpg" alt="">
                        </div>
                        <div class="testimonial-content">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url(<?= get_template_directory_uri() ?>/template/img/bg-img/pc-1.jpg);"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url(<?= get_template_directory_uri() ?>/template/img/bg-img/pc-2.jpg);"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="600ms">
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url(<?= get_template_directory_uri() ?>/template/img/bg-img/pc-3.jpg);"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="700ms">
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url(<?= get_template_directory_uri() ?>/template/img/bg-img/pc-4.jpg);"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="partners-logo d-flex align-items-center justify-content-between flex-wrap">
                        <a href="#"><img src="<?= get_template_directory_uri() ?>/template/img/clients-img/partner-1.png" alt=""></a>
                        <a href="#"><img src="<?= get_template_directory_uri() ?>/template/img/clients-img/partner-2.png" alt=""></a>
                        <a href="#"><img src="<?= get_template_directory_uri() ?>/template/img/clients-img/partner-3.png" alt=""></a>
                        <a href="#"><img src="<?= get_template_directory_uri() ?>/template/img/clients-img/partner-4.png" alt=""></a>
                        <a href="#"><img src="<?= get_template_directory_uri() ?>/template/img/clients-img/partner-5.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
